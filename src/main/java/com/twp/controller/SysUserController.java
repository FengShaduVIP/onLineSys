...
public class SysUserController extends AbstractController {
	...
	public R selectTeach(Integer page, Integer limit){
		Map<String, Object> map = new HashMap<>();
		map.put("offset", (page - 1) * limit);
		map.put("limit", limit);
		List<SysUserEntity> teachList =  sysUserService.queryTeachList(map);
		map.put("level","1");
		int total = sysUserService.queryTotal(map);

		PageUtils pageUtil = new PageUtils(teachList, total, limit, page);
